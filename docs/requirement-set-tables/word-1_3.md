...
||[listas](/javascript/api/word/word.body#lists)|Obtém a coleção de listas de objetos no corpo.|
...
||[listas](/javascript/api/word/word.contentcontrol#lists)|Obtém a coleção de listas de objetos no controle de conteúdo.|
...
||[listas](/javascript/api/word/word.range#lists)|Obtém a coleção de listas de objetos no intervalo.|
