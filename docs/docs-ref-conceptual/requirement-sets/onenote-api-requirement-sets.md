# <a name="onenote-javascript-api-requirement-sets"></a>Conjuntos de requisitos de API JavaScript do OneNote
...
A API JavaScript do OneNote 1.1 é a primeira versão da API. Para obter detalhes sobre a API, consulte [Visão geral de programação de API do JavaScript OneNote](https://docs.microsoft.com/office/dev/add-ins/onenote/onenote-add-ins-programming-overview).
