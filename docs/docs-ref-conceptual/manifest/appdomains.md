# <a name="appdomains-element"></a><span data-ttu-id="0adb4-101">Elemento AppDomains</span><span class="sxs-lookup"><span data-stu-id="0adb4-101">AppDomains element</span></span>
