# <a name="appdomains-element"></a><span data-ttu-id="6afee-101">Elemento AppDomains</span><span class="sxs-lookup"><span data-stu-id="6afee-101">AppDomains element</span></span>
