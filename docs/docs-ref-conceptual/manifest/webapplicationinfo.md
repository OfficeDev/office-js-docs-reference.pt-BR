# <a name="webapplicationinfo-element"></a><span data-ttu-id="f9c0d-101">Elemento WebApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="f9c0d-101">WebApplicationInfo element</span></span>
