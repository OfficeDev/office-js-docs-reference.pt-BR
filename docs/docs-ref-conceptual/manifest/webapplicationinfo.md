...
> [!NOTE] 
> Atualmente, é necessário que o recurso do suplemento corresponde seu Host. O Office não solicitará um token para um suplemento, a menos que possa provar a propriedade, e hoje isso é feito hospedando o suplemento sob o nome de domínio totalmente qualificado do recurso.
