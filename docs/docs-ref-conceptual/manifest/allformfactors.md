# <a name="allformfactors-element"></a><span data-ttu-id="ddf55-101">Elemento AllFormFactors</span><span class="sxs-lookup"><span data-stu-id="ddf55-101">AllFormFactors element</span></span>
