# <a name="appdomain-element"></a><span data-ttu-id="f7682-101">Elemento AppDomain</span><span class="sxs-lookup"><span data-stu-id="f7682-101">AppDomain element</span></span>
