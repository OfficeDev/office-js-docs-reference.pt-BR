# <a name="appdomain-element"></a><span data-ttu-id="c42b4-101">Elemento AppDomain</span><span class="sxs-lookup"><span data-stu-id="c42b4-101">AppDomain element</span></span>
