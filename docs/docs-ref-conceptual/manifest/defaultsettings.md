# <a name="defaultsettings-element"></a><span data-ttu-id="57265-101">Elemento DefaultSettings</span><span class="sxs-lookup"><span data-stu-id="57265-101">DefaultSettings element</span></span>
