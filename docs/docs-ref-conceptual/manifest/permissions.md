# <a name="permissions-element"></a><span data-ttu-id="b5df2-101">Elemento Permissions</span><span class="sxs-lookup"><span data-stu-id="b5df2-101">Permissions element</span></span>
