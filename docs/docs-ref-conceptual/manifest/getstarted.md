# <a name="getstarted-element"></a><span data-ttu-id="d99a9-101">Elemento GetStarted</span><span class="sxs-lookup"><span data-stu-id="d99a9-101">GetStarted element</span></span>
