# <a name="sourcelocation-element"></a><span data-ttu-id="ac217-101">Elemento SourceLocation</span><span class="sxs-lookup"><span data-stu-id="ac217-101">SourceLocation element</span></span>
