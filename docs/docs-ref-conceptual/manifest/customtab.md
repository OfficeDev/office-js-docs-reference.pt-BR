# <a name="customtab-element"></a><span data-ttu-id="de132-101">Elemento CustomTab</span><span class="sxs-lookup"><span data-stu-id="de132-101">CustomTab element</span></span>
