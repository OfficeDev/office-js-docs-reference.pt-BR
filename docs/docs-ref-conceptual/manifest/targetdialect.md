# <a name="targetdialect-element"></a><span data-ttu-id="802ce-101">Elemento TargetDialect</span><span class="sxs-lookup"><span data-stu-id="802ce-101">TargetDialect element</span></span>
