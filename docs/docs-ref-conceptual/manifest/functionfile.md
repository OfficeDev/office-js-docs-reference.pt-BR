# <a name="functionfile-element"></a><span data-ttu-id="de4cb-101">Elemento FunctionFile</span><span class="sxs-lookup"><span data-stu-id="de4cb-101">FunctionFile element</span></span>
