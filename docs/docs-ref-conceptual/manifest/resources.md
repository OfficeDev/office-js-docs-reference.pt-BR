...
> [!NOTE]
> Você deve usar Secure Sockets Layer (SSL) para todas as URLs dos elementos de **imagem** e **Url** .
...
> [!IMPORTANT] 
> O Outlook requer a capacidade de recursos de imagem de cache para fins de desempenho. Por esse motivo, o servidor que hospeda um recurso de imagem não deve adicionar nenhuma diretriz CACHE-CONTROL ao cabeçalho da resposta. Isso fará com que o Outlook substitua automaticamente uma imagem padrão ou genérica.    
