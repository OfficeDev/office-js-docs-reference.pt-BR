# <a name="mobileformfactor-element"></a><span data-ttu-id="dfb17-101">Elemento MobileFormFactor</span><span class="sxs-lookup"><span data-stu-id="dfb17-101">MobileFormFactor element</span></span>
