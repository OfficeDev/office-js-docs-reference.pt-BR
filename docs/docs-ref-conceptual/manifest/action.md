...
> [!NOTE]
> Este elemento não é suportado no Outlook.
...
O exemplo a seguir mostra duas ações que usam um **TaskpaneId** diferente. Para ver esses exemplos em contexto, confira o [exemplo de comando de suplemento simples](https://github.com/OfficeDev/Office-Add-in-Commands-Samples/blob/master/Simple/Manifest/SimpleAddin.xml).
...
> [!NOTE]
> SupportsPinning atualmente tem suporte apenas pelo Outlook 2016 para Windows (compilação 7628.1000 ou posterior).
