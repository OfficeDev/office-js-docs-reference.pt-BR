# <a name="desktopformfactor-element"></a><span data-ttu-id="2a907-101">Elemento DesktopFormFactor</span><span class="sxs-lookup"><span data-stu-id="2a907-101">DesktopFormFactor element</span></span>
