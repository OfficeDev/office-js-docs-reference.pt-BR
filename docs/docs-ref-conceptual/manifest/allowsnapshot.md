# <a name="allowsnapshot-element"></a><span data-ttu-id="bc779-101">Elemento AllowSnapshot</span><span class="sxs-lookup"><span data-stu-id="bc779-101">AllowSnapshot element</span></span>
