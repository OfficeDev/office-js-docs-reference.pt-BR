...
> [!NOTE]
> O `MobileButton` valor para **tipo xsi** é definida no esquema de VersionOverrides 1.1. Ele se aplica somente aos elementos **controle** contidos em um elemento [MobileFormFactor](mobileformfactor.md) .
