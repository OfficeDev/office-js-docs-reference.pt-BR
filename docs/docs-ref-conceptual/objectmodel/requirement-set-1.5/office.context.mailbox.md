...
> [!NOTE]
> Clientes do Outlook conectados a instalações de local do Exchange 2016 com uma URL personalizada do REST configurado retornará um valor inválido para `restUrl`.
