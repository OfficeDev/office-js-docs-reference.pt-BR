...
| [<span data-ttu-id="5c9a0-137">displayNewMessageForm</span><span class="sxs-lookup"><span data-stu-id="5c9a0-137">displayNewMessageForm</span></span>](#displaynewmessageformparameters) | <span data-ttu-id="5c9a0-138">Método</span><span class="sxs-lookup"><span data-stu-id="5c9a0-138">Method</span></span> |
...
##### <a name="type"></a><span data-ttu-id="5c9a0-178">Tipo:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-178">Type:</span></span>
...
##### <a name="parameters"></a><span data-ttu-id="5c9a0-229">Parâmetros:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-229">Parameters:</span></span>
...
<span data-ttu-id="5c9a0-274">Converte uma ID de item formatada para EWS em formato REST.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-274">Converts an item ID formatted for EWS into REST format.</span></span>
...
####  <a name="converttoutcclienttimeinput--date"></a><span data-ttu-id="5c9a0-298">convertToUtcClientTime(input) → {Date}</span><span class="sxs-lookup"><span data-stu-id="5c9a0-298">convertToUtcClientTime(input) → {Date}</span></span>
...
<span data-ttu-id="5c9a0-321">Exibe um compromisso de calendário existente.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-321">Displays an existing calendar appointment.</span></span>
...
##### <a name="example"></a><span data-ttu-id="5c9a0-343">Exemplo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-343">Example</span></span>
...
|<span data-ttu-id="5c9a0-359">Requisito</span><span class="sxs-lookup"><span data-stu-id="5c9a0-359">Requirement</span></span>| <span data-ttu-id="5c9a0-360">Valor</span><span class="sxs-lookup"><span data-stu-id="5c9a0-360">Value</span></span>|
|---|---|
...
##### <a name="parameters"></a><span data-ttu-id="5c9a0-423">Parâmetros:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-423">Parameters:</span></span>
...
<span data-ttu-id="5c9a0-p140">No modo de composição, você deve chamar o método [`saveAsync`](Office.context.mailbox.item.md#saveasyncoptions-callback) para obter um identificador de item para passar ao método `getCallbackTokenAsync`. Seu aplicativo deve ter permissões **ReadWriteItem** para chamar o método `saveAsync`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-p140">In compose mode you must call the [`saveAsync`](Office.context.mailbox.item.md#saveasyncoptions-callback) method to get an item identifier to pass to the `getCallbackTokenAsync` method. Your app must have **ReadWriteItem** permissions to call the `saveAsync` method.</span></span>

##### <a name="parameters"></a><span data-ttu-id="5c9a0-524">Parâmetros:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-524">Parameters:</span></span>

|<span data-ttu-id="5c9a0-525">Nome</span><span class="sxs-lookup"><span data-stu-id="5c9a0-525">Name</span></span>| <span data-ttu-id="5c9a0-526">Tipo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-526">Type</span></span>| <span data-ttu-id="5c9a0-527">Atributos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-527">Attributes</span></span>| <span data-ttu-id="5c9a0-528">Descrição</span><span class="sxs-lookup"><span data-stu-id="5c9a0-528">Description</span></span>|
|---|---|---|---|
|`callback`| <span data-ttu-id="5c9a0-529">function</span><span class="sxs-lookup"><span data-stu-id="5c9a0-529">function</span></span>||<span data-ttu-id="5c9a0-p141">Quando o método for concluído, a função passada ao parâmetro `callback` é chamada com um único parâmetro, `asyncResult`, que é um objeto [`AsyncResult`](/javascript/api/office/office.asyncresult). O token é fornecido como uma cadeia de caracteres na propriedade `asyncResult.value`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-p141">When the method completes, the function passed in the `callback` parameter is called with a single parameter, `asyncResult`, which is an [`AsyncResult`](/javascript/api/office/office.asyncresult) object. The token is provided as a string in the `asyncResult.value` property.</span></span>|
|`userContext`| <span data-ttu-id="5c9a0-532">Objeto</span><span class="sxs-lookup"><span data-stu-id="5c9a0-532">Object</span></span>| <span data-ttu-id="5c9a0-533">&lt;opcional&gt;</span><span class="sxs-lookup"><span data-stu-id="5c9a0-533">&lt;optional&gt;</span></span>|<span data-ttu-id="5c9a0-534">Quaisquer dados de estado que são passados ao método assíncrono.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-534">Any state data that is passed to the asynchronous method.</span></span>|

##### <a name="requirements"></a><span data-ttu-id="5c9a0-535">Requisitos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-535">Requirements</span></span>

|<span data-ttu-id="5c9a0-536">Requisito</span><span class="sxs-lookup"><span data-stu-id="5c9a0-536">Requirement</span></span>| <span data-ttu-id="5c9a0-537">Valor</span><span class="sxs-lookup"><span data-stu-id="5c9a0-537">Value</span></span>|
|---|---|
|[<span data-ttu-id="5c9a0-538">Versão do conjunto de requisitos mínimos da caixa de correio</span><span class="sxs-lookup"><span data-stu-id="5c9a0-538">Minimum mailbox requirement set version</span></span>](/javascript/office/requirement-sets/outlook-api-requirement-sets)| <span data-ttu-id="5c9a0-539">1.3</span><span class="sxs-lookup"><span data-stu-id="5c9a0-539">1.3</span></span>|
|[<span data-ttu-id="5c9a0-540">Nível de permissão mínimo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-540">Minimum permission level</span></span>](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| <span data-ttu-id="5c9a0-541">ReadItem</span><span class="sxs-lookup"><span data-stu-id="5c9a0-541">ReadItem</span></span>|
|[<span data-ttu-id="5c9a0-542">Modo do Outlook aplicável</span><span class="sxs-lookup"><span data-stu-id="5c9a0-542">Applicable Outlook mode</span></span>](https://docs.microsoft.com/outlook/add-ins/#extension-points)| <span data-ttu-id="5c9a0-543">Redigir e ler</span><span class="sxs-lookup"><span data-stu-id="5c9a0-543">Compose and read</span></span>|

##### <a name="example"></a><span data-ttu-id="5c9a0-544">Exemplo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-544">Example</span></span>
...
####  <a name="getuseridentitytokenasynccallback-usercontext"></a><span data-ttu-id="5c9a0-545">getUserIdentityTokenAsync(callback, [userContext])</span><span class="sxs-lookup"><span data-stu-id="5c9a0-545">getUserIdentityTokenAsync(callback, [userContext])</span></span>

<span data-ttu-id="5c9a0-546">Obtém um símbolo que identifica o usuário e o suplemento do Office.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-546">Gets a token identifying the user and the Office Add-in.</span></span>

<span data-ttu-id="5c9a0-547">O método `getUserIdentityTokenAsync` retorna um token que pode ser utilizado para identificar e [autenticar o suplemento e o usuário com um sistema de terceiros](https://docs.microsoft.com/outlook/add-ins/authentication).</span><span class="sxs-lookup"><span data-stu-id="5c9a0-547">The `getUserIdentityTokenAsync` method returns a token that you can use to identify and [authenticate the add-in and user with a third-party system](https://docs.microsoft.com/outlook/add-ins/authentication).</span></span>

##### <a name="parameters"></a><span data-ttu-id="5c9a0-548">Parâmetros:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-548">Parameters:</span></span>

|<span data-ttu-id="5c9a0-549">Nome</span><span class="sxs-lookup"><span data-stu-id="5c9a0-549">Name</span></span>| <span data-ttu-id="5c9a0-550">Tipo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-550">Type</span></span>| <span data-ttu-id="5c9a0-551">Atributos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-551">Attributes</span></span>| <span data-ttu-id="5c9a0-552">Descrição</span><span class="sxs-lookup"><span data-stu-id="5c9a0-552">Description</span></span>|
|---|---|---|---|
|`callback`| <span data-ttu-id="5c9a0-553">function</span><span class="sxs-lookup"><span data-stu-id="5c9a0-553">function</span></span>||<span data-ttu-id="5c9a0-554">Quando o método for concluído, a função passada ao parâmetro `callback` é chamada com um único parâmetro, `asyncResult`, que é um objeto [`AsyncResult`](/javascript/api/office/office.asyncresult).</span><span class="sxs-lookup"><span data-stu-id="5c9a0-554">When the method completes, the function passed in the `callback` parameter is called with a single parameter, `asyncResult`, which is an [`AsyncResult`](/javascript/api/office/office.asyncresult) object.</span></span><br/><br/><span data-ttu-id="5c9a0-555">O token é fornecido como uma cadeia de caracteres na propriedade `asyncResult.value`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-555">The token is provided as a string in the `asyncResult.value` property.</span></span>|
|`userContext`| <span data-ttu-id="5c9a0-556">Object</span><span class="sxs-lookup"><span data-stu-id="5c9a0-556">Object</span></span>| <span data-ttu-id="5c9a0-557">&lt;opcional&gt;</span><span class="sxs-lookup"><span data-stu-id="5c9a0-557">&lt;optional&gt;</span></span>|<span data-ttu-id="5c9a0-558">Quaisquer dados de estado que são passados ao método assíncrono.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-558">Any state data that is passed to the asynchronous method.</span></span>|

##### <a name="requirements"></a><span data-ttu-id="5c9a0-559">Requisitos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-559">Requirements</span></span>

|<span data-ttu-id="5c9a0-560">Requisito</span><span class="sxs-lookup"><span data-stu-id="5c9a0-560">Requirement</span></span>| <span data-ttu-id="5c9a0-561">Valor</span><span class="sxs-lookup"><span data-stu-id="5c9a0-561">Value</span></span>|
|---|---|
|[<span data-ttu-id="5c9a0-562">Versão do conjunto de requisitos mínimos da caixa de correio</span><span class="sxs-lookup"><span data-stu-id="5c9a0-562">Minimum mailbox requirement set version</span></span>](/javascript/office/requirement-sets/outlook-api-requirement-sets)| <span data-ttu-id="5c9a0-563">1.0</span><span class="sxs-lookup"><span data-stu-id="5c9a0-563">1.0</span></span>|
|[<span data-ttu-id="5c9a0-564">Nível de permissão mínimo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-564">Minimum permission level</span></span>](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| <span data-ttu-id="5c9a0-565">ReadItem</span><span class="sxs-lookup"><span data-stu-id="5c9a0-565">ReadItem</span></span>|
|[<span data-ttu-id="5c9a0-566">Modo do Outlook aplicável</span><span class="sxs-lookup"><span data-stu-id="5c9a0-566">Applicable Outlook mode</span></span>](https://docs.microsoft.com/outlook/add-ins/#extension-points)| <span data-ttu-id="5c9a0-567">Composição ou leitura</span><span class="sxs-lookup"><span data-stu-id="5c9a0-567">Compose or read</span></span>|

##### <a name="example"></a><span data-ttu-id="5c9a0-568">Exemplo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-568">Example</span></span>
...
####  <a name="makeewsrequestasyncdata-callback-usercontext"></a><span data-ttu-id="5c9a0-569">makeEwsRequestAsync(data, callback, [userContext])</span><span class="sxs-lookup"><span data-stu-id="5c9a0-569">makeEwsRequestAsync(data, callback, [userContext])</span></span>

<span data-ttu-id="5c9a0-570">Faz uma solicitação assíncrona em um serviço dos Serviços Web do Exchange (EWS) no servidor Exchange que hospeda a caixa de correio do usuário.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-570">Makes an asynchronous request to an Exchange Web Services (EWS) service on the Exchange server that hosts the user’s mailbox.</span></span>

> [!NOTE]
> <span data-ttu-id="5c9a0-571">Esse método não é suportado nos seguintes cenários.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-571">This method is not supported in the following scenarios.</span></span>
> - <span data-ttu-id="5c9a0-572">No Outlook para iOS ou no Outlook para Android</span><span class="sxs-lookup"><span data-stu-id="5c9a0-572">In Outlook for iOS or Outlook for Android</span></span>
> - <span data-ttu-id="5c9a0-573">Quando o suplemento for carregado em uma caixa de correio do Gmail</span><span class="sxs-lookup"><span data-stu-id="5c9a0-573">When the add-in is loaded in a Gmail mailbox</span></span>
> 
> <span data-ttu-id="5c9a0-574">Nesses casos, suplementos devem [usar APIs REST](https://docs.microsoft.com/outlook/add-ins/use-rest-api) para acessar a caixa de correio do usuário.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-574">In these cases, add-ins should [use REST APIs](https://docs.microsoft.com/outlook/add-ins/use-rest-api) to access the user's mailbox instead.</span></span>

<span data-ttu-id="5c9a0-575">O método `makeEwsRequestAsync` envia uma solicitação do EWS em nome do suplemento ao Exchange.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-575">The `makeEwsRequestAsync` method sends an EWS request on behalf of the add-in to Exchange.</span></span> <span data-ttu-id="5c9a0-576">Para obter uma lista das operações EWS suportadas, consulte [chame serviços web a partir de um suplemento do Outlook](https://docs.microsoft.com/outlook/add-ins/web-services#ews-operations-that-add-ins-support) .</span><span class="sxs-lookup"><span data-stu-id="5c9a0-576">See [Call web services from an Outlook add-in](https://docs.microsoft.com/outlook/add-ins/web-services#ews-operations-that-add-ins-support) for a list of the supported EWS operations.</span></span>

<span data-ttu-id="5c9a0-577">Não é possível solicitar os itens associados da pasta com o método `makeEwsRequestAsync`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-577">You cannot request Folder Associated Items with the `makeEwsRequestAsync` method.</span></span>

<span data-ttu-id="5c9a0-578">A solicitação XML deve especificar a codificação UTF-8.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-578">The XML request must specify UTF-8 encoding.</span></span>

```
<?xml version="1.0" encoding="utf-8"?>
```

<span data-ttu-id="5c9a0-p143">O suplemento deve ter a permissão **ReadWriteMailbox** para usar o método `makeEwsRequestAsync`. Para saber mais sobre como usar a permissão **ReadWriteMailbox** e as operações do EWS que você pode chamar com o método `makeEwsRequestAsync`, confira [Especificar permissões para acesso de suplemento de email na caixa de correio do usuário](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions).</span><span class="sxs-lookup"><span data-stu-id="5c9a0-p143">Your add-in must have the **ReadWriteMailbox** permission to use the `makeEwsRequestAsync` method. For information about using the **ReadWriteMailbox** permission and the EWS operations that you can call with the `makeEwsRequestAsync` method, see [Specify permissions for mail add-in access to the user's mailbox](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions).</span></span>

> [!NOTE]
> <span data-ttu-id="5c9a0-581">O administrador do servidor deve ser definida `OAuthAuthentication` como true no diretório do EWS de servidor de acesso de cliente para habilitar o `makeEwsRequestAsync` método para tornar o EWS solicita.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-581">The server administrator must set `OAuthAuthentication` to true on the Client Access Server EWS directory to enable the `makeEwsRequestAsync` method to make EWS requests.</span></span>

##### <a name="version-differences"></a><span data-ttu-id="5c9a0-582">Diferenças de versão</span><span class="sxs-lookup"><span data-stu-id="5c9a0-582">Version differences</span></span>

<span data-ttu-id="5c9a0-583">Ao usar o método `makeEwsRequestAsync` nos aplicativos de email em execução em versões do Outlook anteriores à 15.0.4535.1004, é preciso definir o valor de codificação como `ISO-8859-1`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-583">When you use the `makeEwsRequestAsync` method in mail apps running in Outlook versions earlier than version 15.0.4535.1004, you should set the encoding value to `ISO-8859-1`.</span></span>

```
<?xml version="1.0" encoding="iso-8859-1"?>
```

<span data-ttu-id="5c9a0-p144">Não é necessário definir o valor de codificação quando o aplicativo de email estiver em execução no Outlook na Web. Você pode determinar se o aplicativo de email está em execução no Outlook ou no Outlook na Web usando a propriedade mailbox.diagnostics.hostName. Você pode determinar que versão do Outlook está em execução usando a propriedade mailbox.diagnostics.hostVersion.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-p144">You do not need to set the encoding value when your mail app is running in Outlook on the web. You can determine whether your mail app is running in Outlook or Outlook on the web by using the mailbox.diagnostics.hostName property. You can determine what version of Outlook is running by using the mailbox.diagnostics.hostVersion property.</span></span>

##### <a name="parameters"></a><span data-ttu-id="5c9a0-587">Parâmetros:</span><span class="sxs-lookup"><span data-stu-id="5c9a0-587">Parameters:</span></span>

|<span data-ttu-id="5c9a0-588">Nome</span><span class="sxs-lookup"><span data-stu-id="5c9a0-588">Name</span></span>| <span data-ttu-id="5c9a0-589">Tipo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-589">Type</span></span>| <span data-ttu-id="5c9a0-590">Atributos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-590">Attributes</span></span>| <span data-ttu-id="5c9a0-591">Descrição</span><span class="sxs-lookup"><span data-stu-id="5c9a0-591">Description</span></span>|
|---|---|---|---|
|`data`| <span data-ttu-id="5c9a0-592">Cadeia de caracteres</span><span class="sxs-lookup"><span data-stu-id="5c9a0-592">String</span></span>||<span data-ttu-id="5c9a0-593">A solicitação do EWS.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-593">The EWS request.</span></span>|
|`callback`| <span data-ttu-id="5c9a0-594">function</span><span class="sxs-lookup"><span data-stu-id="5c9a0-594">function</span></span>||<span data-ttu-id="5c9a0-595">Quando o método for concluído, a função passada ao parâmetro `callback` é chamada com um único parâmetro, `asyncResult`, que é um objeto [`AsyncResult`](/javascript/api/office/office.asyncresult).</span><span class="sxs-lookup"><span data-stu-id="5c9a0-595">When the method completes, the function passed in the `callback` parameter is called with a single parameter, `asyncResult`, which is an [`AsyncResult`](/javascript/api/office/office.asyncresult) object.</span></span><br/><br/><span data-ttu-id="5c9a0-596">O resultado XML da chamada do EWS é fornecido como uma cadeia de caracteres na propriedade `asyncResult.value`.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-596">The XML result of the EWS call is provided as a string in the `asyncResult.value` property.</span></span> <span data-ttu-id="5c9a0-597">Se o resultado exceder 1 MB em tamanho, uma mensagem de erro será retornada em vez disso.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-597">If the result exceeds 1 MB in size, an error message is returned instead.</span></span>|
|`userContext`| <span data-ttu-id="5c9a0-598">Objeto</span><span class="sxs-lookup"><span data-stu-id="5c9a0-598">Object</span></span>| <span data-ttu-id="5c9a0-599">&lt;opcional&gt;</span><span class="sxs-lookup"><span data-stu-id="5c9a0-599">&lt;optional&gt;</span></span>|<span data-ttu-id="5c9a0-600">Quaisquer dados de estado que são passados ao método assíncrono.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-600">Any state data that is passed to the asynchronous method.</span></span>|

##### <a name="requirements"></a><span data-ttu-id="5c9a0-601">Requisitos</span><span class="sxs-lookup"><span data-stu-id="5c9a0-601">Requirements</span></span>

|<span data-ttu-id="5c9a0-602">Requisito</span><span class="sxs-lookup"><span data-stu-id="5c9a0-602">Requirement</span></span>| <span data-ttu-id="5c9a0-603">Valor</span><span class="sxs-lookup"><span data-stu-id="5c9a0-603">Value</span></span>|
|---|---|
|[<span data-ttu-id="5c9a0-604">Versão do conjunto de requisitos mínimos da caixa de correio</span><span class="sxs-lookup"><span data-stu-id="5c9a0-604">Minimum mailbox requirement set version</span></span>](/javascript/office/requirement-sets/outlook-api-requirement-sets)| <span data-ttu-id="5c9a0-605">1.0</span><span class="sxs-lookup"><span data-stu-id="5c9a0-605">1.0</span></span>|
|[<span data-ttu-id="5c9a0-606">Nível de permissão mínimo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-606">Minimum permission level</span></span>](https://docs.microsoft.com/outlook/add-ins/understanding-outlook-add-in-permissions)| <span data-ttu-id="5c9a0-607">ReadWriteMailbox</span><span class="sxs-lookup"><span data-stu-id="5c9a0-607">ReadWriteMailbox</span></span>|
|[<span data-ttu-id="5c9a0-608">Modo do Outlook aplicável</span><span class="sxs-lookup"><span data-stu-id="5c9a0-608">Applicable Outlook mode</span></span>](https://docs.microsoft.com/outlook/add-ins/#extension-points)| <span data-ttu-id="5c9a0-609">Composição ou leitura</span><span class="sxs-lookup"><span data-stu-id="5c9a0-609">Compose or read</span></span>|

##### <a name="example"></a><span data-ttu-id="5c9a0-610">Exemplo</span><span class="sxs-lookup"><span data-stu-id="5c9a0-610">Example</span></span>

<span data-ttu-id="5c9a0-611">O exemplo a seguir chama `makeEwsRequestAsync` para usar a operação `GetItem` para obter o assunto de um item.</span><span class="sxs-lookup"><span data-stu-id="5c9a0-611">The following example calls `makeEwsRequestAsync` to use the `GetItem` operation to get the subject of an item.</span></span>
